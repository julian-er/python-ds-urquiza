...
ej_1 = tkinter_basics(title='ejercicio 1', iconUrl='./icons/j2.ico', rows=5)
...
user_name.grid(column=2, columnspan=2, sticky=NW, row=1, rowspan=1, padx=3, pady=3)

user_password = Label(ej_1.root, text="Password : ", fg="white", background='#000000')
user_password.grid(column=2, columnspan=2, sticky=NW, row=3, rowspan=1, padx=3, pady=3)

# Entries
username_entry = Entry(textvariable=username)
username_entry.grid(column=2, columnspan=2, sticky=NW, row=2, rowspan=1, padx=3, pady=3)

password_entry = Entry(textvariable=password,  show='*')
password_entry.grid(column=2, columnspan=2, sticky=NW, row=4, rowspan=1, padx=3, pady=3)


# Adapt size
ej_1.root.minsize(200,200)
